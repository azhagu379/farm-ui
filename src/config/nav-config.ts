...
import { Home, Package, ShoppingCart, Users, Store, Settings, User, Sparkles, Gift,  Leaf, Star, TrendingUp, Compass, ShoppingBag } from 'lucide-react'; 
  ...
  }, 
  {
    ...
    links: [
      ...
      }, 
      {
        ...
        roles: ['BUYER', 'FARMER', 'ADMIN'], // Anyone with a cart, once logged in
      },
      {
